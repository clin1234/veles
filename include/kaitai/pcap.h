...
public:
    ...
    private:
        packet_ppi_t* m_ppi_body;
        bool n_ppi_body;

    public:
        bool _is_null_ppi_body() { ppi_body(); return n_ppi_body; };

    private:
        ethernet_frame_t* m_ethernet_body;
        bool n_ethernet_body;

    public:
        bool _is_null_ethernet_body() { ethernet_body(); return n_ethernet_body; };

    private:
        pcap_t* m__root;
        pcap_t* m__parent;
        std::string m__raw_ppi_body;
        kaitai::kstream* m__io__raw_ppi_body;
        std::string m__raw_ethernet_body;
        kaitai::kstream* m__io__raw_ethernet_body;
    ...
    public:
        ...
        std::string body() const { return m_body; }
        packet_ppi_t* ppi_body() const { return m_ppi_body; }
        ethernet_frame_t* ethernet_body() const { return m_ethernet_body; }
        pcap_t* _root() const { return m__root; }
        pcap_t* _parent() const { return m__parent; }
        std::string _raw_ppi_body() const { return m__raw_ppi_body; }
        kaitai::kstream* _io__raw_ppi_body() const { return m__io__raw_ppi_body; }
        std::string _raw_ethernet_body() const { return m__raw_ethernet_body; }
        kaitai::kstream* _io__raw_ethernet_body() const { return m__io__raw_ethernet_body; }
    };
