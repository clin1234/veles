...
private:
    ...
    tcp_segment_t* m_tcp_segment_body;
    bool n_tcp_segment_body;

public:
    bool _is_null_tcp_segment_body() { tcp_segment_body(); return n_tcp_segment_body; };

private:
    icmp_packet_t* m_icmp_body;
    bool n_icmp_body;

public:
    bool _is_null_icmp_body() { icmp_body(); return n_icmp_body; };
...
public:
    ...
    tcp_segment_t* tcp_segment_body() const { return m_tcp_segment_body; }
    icmp_packet_t* icmp_body() const { return m_icmp_body; }
    std::string body() const { return m_body; }
    ipv4_packet_t* _root() const { return m__root; }
