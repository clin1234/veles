...
- `Qt` for `msvc2022_64`
- `Visual Studio 2022` (Community edition is enough; you will need MSVC even
when using only Qt Creator)
- `cmake` + `git` (both can be installed with Visual Studio)
- `perl` (only for building OpenSSL; e.g.
[Strawberry Perl](http://strawberryperl.com/))
- `Python3.10+` (you will also need to install dependencies from
      ...
      "variables": [
        {
          ...
          "value": "C:\\Qt\\5.15.19\\msvc2022_64"
        },
        {
...
`veles-build-${name}\openssl-1.0.2u\out32dll` to a separate folder outside the
...
1. Install the [latest LLVM release](https://github.com/llvm/llvm-project/releases).
...
free to create an issue at https://github.com/clin1234/veles/issues.
